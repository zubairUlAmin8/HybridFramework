...
public interface LoginPageOR {
     ...
     By emailIF=By.cssSelector("#email");
     By passwordIF=By.cssSelector("#password");
     By loginBtn=By.xpath("//span[text()=\"Login\"]");
     By validationError=By.xpath("//strong[text()=\"These credentials do not match our records.\"]");
     By credentialRequiredAlert=By.cssSelector("#error_message");
